 ...
 <script src="{{ secure_asset('assets/js/plugins/jquery-jvectormap.js') }}"></script>
 ...
 <script src="{{ secure_asset('assets/js/material-dashboard.js?v=2.1.1') }}" type="text/javascript"></script>
