...
@section('content')
              ...
              <div class="card"> 
                ...
                <div class="card-body">
                      <div class="table-responsive">
                          <div align="right">
                            <a href="{{route('comptables.create')}}"><div class="btn btn-success">Nouveau comptable&nbsp;<i class="fas fa-user-plus"></i></div></a>
                          </div>
                          <br />
                        <table class="table table-bordered table-striped" width="100%" cellspacing="0" id="table-comptables">
      ...
      <div class="modal fade" id="modal_delete_comptable" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          ...
          $('#table-comptables').DataTable( { 
            ...
            columns: [
                ...
                "columnDefs": [
                        ...
                        '<div class="btn btn-danger delete btn_delete_comptable" title="Supprimer" data-href='+url_d+'><i class="fas fa-times">&nbsp;Delete</i></div>';
                        },
                        "targets": 6
                        },
                ],
