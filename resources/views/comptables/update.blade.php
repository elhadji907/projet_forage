        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header card-header-primary text-center">
                    ...
                    <p class="card-category">Comptable</p>
                </div>
                <div class="card-body">
                                               
                        <form method="POST" action="{{ action('ComptableController@update', $id) }}">
                            {{ csrf_field() }}
                            <input type="hidden" name="_method" value="PATCH" />                         
                            <div class="form-group">
                                <label for="input-matricule"><b>Matricule:</b></label>
                                <input type="text" name="matricule" class="form-control" id="input-matricule" placeholder="Matricule" value="{{ $comptable->matricule }}">
